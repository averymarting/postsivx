...
LOOP_INTERVAL_SECONDS = 7200  # 60 minutes between cycles
...
LINK_URL = "https://lvx.teentoday.cfd"
LINK_DISPLAY_TEXT = "lvx.teentoday.cfd"
...
def build_post(tags: list[str]) -> TextBuilder:
    ...
    Final post layout:
        ...
        lvx.teentoday.cfd   (clickable link, opens with no warning)
        \n
        #tag1 #tag2 #tag3 ...
    """
    tb = TextBuilder()
